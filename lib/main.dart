...
import 'package:add_to_cart_api/utils/routes/route_settings.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => HomeScreenStateMangement())
      ],
      child: MaterialApp(
        initialRoute: RouteNames.loginScreenRoute,
